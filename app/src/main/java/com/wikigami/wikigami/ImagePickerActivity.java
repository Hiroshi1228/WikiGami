...
public class ImagePickerActivity extends AppCompatActivity {
    ...
    private void cropImage(Uri sourceUri) {
        ...
        options.setToolbarColor(ContextCompat.getColor(this, R.color.purple_200));
        options.setStatusBarColor(ContextCompat.getColor(this, R.color.azul1));
        options.setActiveWidgetColor(ContextCompat.getColor(this, R.color.turquesa));
